...
const TRACKS = [
  ...
  { name: 'Cafuné - Tek It', file: '/Cafuné - Tek It.mp3' },
  ...
  { name: 'Moe Shop - LOVE RECORD', file: '/Moe Shop - LOVE RECORD.mp3' },
  ...
  { name: 'Persona 3 - Memories of You', file: '/Persona 3 - Memories of You.mp3' },
...
const CREDITS_DATA: CreditSection[] = [
  ...
  },
  {
    ...
    leftPhotos: [
      { src: 'christians_peak_1.png', caption: 'Us together after bowling' },
      { src: 'christians_peak_luis_mata_moreno.jpg', caption: 'Luis and his interesting shirts' },
    ],
    rightPhotos: [
      { src: 'christians_peak_2.png', caption: 'Louis, Andrew and I in Georgia (after trish graduation)' },
    ],
    entries: [
  ...
  },
  {
    ...
    entries: [
      { name: 'Anthony Dreier', role: "Really smart guy, really cool." },
      { name: 'Colby Bradford', role: "Really good friend of mine. We went through the trenches of AEM and VLSI together. Really good to talk to, really smart, and super involved with IEEE and symposium. Really cares about his club and his friends. Super funny. Amazing to be around." },
  ...
  },
  {
    title: 'RAs/CDs',
    entries: [
      { name: 'Emily Rivera', role: "Really nice. Known her for a long time. Super sweet person." },
      { name: 'Maddox Bown', role: "Really cool guy. Only got to know him this semester but he's really funny. Great to be around." },
    ],
  },
  {
    ...
    entries: [
      { name: 'Brianna Pratts' },
      { name: 'Casen Simmons' },
      { name: 'Conor Wilson', role: "funny guy"},
      ...
      { name: 'Ms. Burnett', role: "Taught me English 3 and college english. Drove me to SFSC when I needed it"},
      { name: 'Ms. Curry', role: "Taught me English 2, believed in me. Did Turkey Scavenger Hunt with her every year." },
      { name: 'Ms. Sohn', role: "Got me into service." },
    ],
  },
  {
    title: 'Paul Patullo',
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'Tyler Critchlow', role: "Sam's husband. Super funny. A lot of good memories with him." },
      { name: 'Kora Catlin', role: "Really nice." },
    ],
  },
  {
    title: 'Party Animals',
  ...
  },
  {
    ...
    entries: [
      { name: 'Vanessa Korthas', role: "Also known as Bethany. Really cool. Played Killjoy for our team." },
      { name: 'Jaden Akers-Atkins', role: "Also known as Jay. Gamertag: Neitherox. Played Skye. Set me up for a lot of duels and is part of why we won our games." },
      { name: 'Johnathan Nguyen', role: "Duelist. Really good at Valorant. Talk to him all the time at the gym." },
      { name: 'Julian Amato', role: "Cool guy. See him at the gym. Also, sorry for one-tapping you so many times during tryouts." },
      { name: 'Ryan Trinh', role: "Aeri. Duelist, plays Neon. Really cool guy. Also see him at the gym." },
      { name: 'Wack', role: "ThatsWack. Our team captain. Played Omen for us, great callouts, great smokes. A big reason why we won the games we did. Cool dude." },
    ],
  },
  {
    ...
    entries: [
      ...
      { name: 'Hiep Nguyen', role: 'My number one role model and genuinely the most experienced in tech person I know. I go to him for all my problems and he seems to have all the answers. Definiely who I look up to who I aspire to be.' },
      { name: 'Jeremiah Joseph', role: "Fellow volunteer from Mikey's church. He's younger and wasn't sure what he wanted to do, so I walked him through a bunch of different areas in tech to help him figure it out. I have high hopes for him. Pretty cool guy." },
      { name: 'Jose Vega' },
      { name: 'Joshua Stone' },
      { name: 'Katiya Taylor' },
      { name: 'Michael Adams' },
      { name: 'Mikey LaFollette', role: "Incredibly funny cowoker. So glad to have gotten to know him and work with him."},
      { name: 'Nickolas Phan', role: "It's been so interesting to see you grow from someone timid and shy to someone who instigates me any chance he gets. The GOAT. Loves the same animes and songs as me. Super cool."},
      { name: 'Pickleball John', role: "We gotta play Val soon. Amazing going to the church with you. Amazing guy." },
      { name: 'Prathyusha Bhuma' },
      { name: 'Raul Gonzales', role: "My LIBRARY GOAT! Super cool, loves the same games as me. One of the coolest guys I met through Winter Haven."},
      { name: 'Robert van Druten' },
      { name: 'The Winter Haven Librarians', role: "Thank you Rebecca, Corinne, Cori, Jane, Skylyn, and the others I'm 100% forgetting."},
      { name: 'Wen Zhang' },
    ],
  },
  {
    ...
    entries: [
      { name: 'Alfonso Contreras', role: "GOAT" },
      { name: 'Alis Craig' },
      { name: 'Andrew Blackwelder', role: "GOAT. His cousin is dating my cousin whos also named Andrew. Good partner to have on a project!"},
      { name: "Jessica Steffen", role: "Andrew Blackwelder's cousin and the one's who dating my cousin!" },
      { name: 'Andrew Ptazek' },
      { name: 'Anthony Parinello', role: "My ITALIAN GOAT" },
      { name: 'Brady Lenox' },
      { name: 'Nico Rapp'},
      { name: 'Clara Satterfield', role: "One of the first people I've met at Poly. Incredibly nice and I'm so glad I got to meet her."},
      ...
      { name: 'David Vidana' },
      { name: 'David Zambrano' },
      { name: 'Eddrick Tirado Lozada', role: "my EE GOAT." },
      { name: 'Eli Wolfe' },
      { name: 'Elijah Kenney' },
      { name: 'Emily Hanson' },
      { name: 'Erich Esqueda' },
      ...
      { name: 'Gabby Villalba', role: "Incredibly nice until she gets beaten in Mario Kart. Then she chokes you."},
      { name: 'Giana Reyes', role: "So sweet and kind. Amazing having you in Philly with us!" },
      { name: 'Jacob Paccione' },
      { name: 'Jannice Rivera' },
      ...
      { name: 'Kyle Trotter' },
      { name: 'Kyle Blanchard' },
      { name: 'Lauren Schneider', role: "Shriraj's girlfriend, very nice but didn't like I called her a Mega Victreebel"},
      { name: 'Leia Hok' },
      { name: 'Katie Foley'},
      { name: 'Emma Foley'},
      { name: 'Dad & Mom Foley'},
      ...
      { name: 'Zander Butler', role: "GOAT"},
      { name: 'Zane Wolfe', role: "The King of DevOps. Incredibly smart at CS, can go to him for anything"},
      { name: 'Eduardo Jirau'},
      { name: 'Jes Pate'},
      { name: 'Joseph Wright'},
      { name: 'Noah Vanscoyoc', role: "GOAT"},
      { name: 'Sean Fisher', role: "'Guys, I think I'm gonna write 'Jeremy and the Chuds' just ONE more time, it'll still be funny'"},
      { name: 'Cyler Gabel' },
      { name: 'John Sengchanh'},
      { name: 'Daniel Freer'},
      { name: 'Adrian Sanchez' },
  ...
  /* ── End sections ── */
  {
    ...
    entries: [
      { name: 'Alibaba', role: "Actually one of the first online friends I made. She's super cool and in a similar field to me last I checked. A fellow Jett main" },
      ...
      { name: 'Elysha' },
      { name: 'Emily Lu' },
      { name: 'Genia Korovaychuk', role: "the reason why I dropped 50 in fortnite" },
      ...
      { name: 'Ouroborix' },
      { name: 'Ridge' },
      { name: 'Ryan Landy', role: "not good at fortnite nor good at val. jk she's fun to play with"},
      { name: 'Savanna' },
...
export function Credits() {
  ...
  /* ── Mobile layout: section photos interleaved with name groups ── */
