...
const CREDITS_DATA: CreditSection[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      { name: 'Jaden Akers-Atkins', role: "Also known as Jay. Gamertag: NeitherRocks. Played Skye. Set me up for a lot of duels and is part of why we won our games." },
      { name: 'Johnathan Nguyen', role: "Duelist. Really good at Valorant. Used to talk to him all the time at the gym." },
      { name: 'Julian Amato', role: "Cool guy. Love going to the gym with him. Also, sorry for one-tapping you so many times during tryouts." },
      { name: 'Ryan Trinh', role: "Also known as Aeri. Duelist, plays Neon. Really cool guy. Also go to the gym with him." },
      { name: 'Wack', role: "Gamertag: ThatsWack. Our team captain. Played Omen for us, great callouts, great smokes. A big reason why we won the games we did. Cool dude." },
    ],
  },
  {
