...
# Label
L1 = Label(window, text="Handwritten Digit Recoginition", font=('Comic Sans', 25), fg="blue")
L1.place(x=35, y=10)

# Button to clear canvas
b1 = Button(window, text="1. Clear Canvas", font=('Comic Sans', 15), bg="orange", fg="black", command=clear_widget)
b1.place(x=120, y=370)

# Button to predict digit drawn on canvas
b2 = Button(window, text="2. Prediction", font=('Comic Sans', 15), bg="white", fg="red", command=MyProject)
